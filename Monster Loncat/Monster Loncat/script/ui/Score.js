var Score = function(game){
    ...
    Score.prototype = {
        ...
        createScore: function(){
            ...
            var scoreFont = "50px Georgia";
            this.scoreLabel = game.add.text(game.world.centerX,game.height-100,'0',{font: scoreFont, fill: ' #a3ebad', stroke: '#ffffff', strokeThickness: 6});
