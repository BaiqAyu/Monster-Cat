  ...
  loadState.prototype = {
      ...
      preload: function(){
          ...
          var Font = "40px Comic Sans MS";
            this.loadText = this.add.text(this.world.centerX,this.world.centerY,'loading ',{font: Font, fill: '#44ee12', stroke: '#55a50d', strokeThickness: 3});
          ...
          */
          ...
          // load GUI
           ...
           this.load.image('settingBtn','assets/GUI/setting.png')
