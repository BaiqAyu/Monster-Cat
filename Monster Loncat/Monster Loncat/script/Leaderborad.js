var leaderboardState = function(game){
    ...
    this.style = { font: "bold 34px Arial", fill: "#fff",boundsAlignH:"center", tabs: [ 100, 300 ] };
    this.textStyle = { font: "28px Comic Sans MS",stroke: '#ffffff', strokeThickness: 4, fill: "#fd1619", tabs: [ 100, 300 ] };
...
leaderboardState.prototype = {
    ...
    create: function(){
        ...
        this.game.stage.backgroundColor = '#0a2336';
...
this.game.state.start('Menu');
        ...
        var playerScore;
            ...
            if(localStorage.getItem('highscore')===null){
                ...
                playerScore = this.add.text(this.world.centerX,180,'High Score = '+localStorage.getItem('highscore'),this.textStyle);
